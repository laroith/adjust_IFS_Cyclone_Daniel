#!/bin/bash 
#SBATCH --job-name=ADJUST_PS_TEST
...
do
    ...
    python /gpfs/data/fs72281/lar/change_temp/CC_signals_Laurenz/${INPUT_DIR_CAS}/adjust_PS_only.py "$FILE" $GCM_NAME $INPUT_DIR_CAS $OUTPUT_DIR_CAS 
done
