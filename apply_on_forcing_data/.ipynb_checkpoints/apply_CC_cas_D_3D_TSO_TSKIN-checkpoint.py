...
cc_signal_file_path = f"{args.input_dir_CC_mrso}/CC_{args.gcm_name}_3D_remapcon_TS_TSKIN.nc_minus_1K"
...
tskin_condition = np.isfinite(ts_new) & (ts_new > 0)
...
file_cas_new['T_SKIN'] = xr.where(tskin_condition, ts_new, file_cas_new['T_SKIN'], keep_attrs=True)
